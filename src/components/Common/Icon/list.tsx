interface ListType {
  [key: string]: (x: string, y: number) => JSX.Element;
}

const icons: ListType = {
  flag: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  user_edit: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  user_check: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  user_add: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  trash: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  share: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  setting: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  plus_square: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  paragraph: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  paper: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  emoji: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  email: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  disable: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  comment: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  close: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  chevron_right: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  chevron_left: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  chevron_down_circle: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  chevron_down: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  calende_empty: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
  ...
  check_circle: (color: string, size: number) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
  ...
  profile_edit: (color: string, size: number) => {
    return (
      <svg
        width={size}
        height={size}
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M15 5.7C16.7 7.4 16.7 10.1 15 11.7C13.3 13.3 10.6 13.4 8.99999 11.7C7.39999 10 7.29999 7.3 8.99999 5.7C10.7 4.1 13.3 4.1 15 5.7" stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round" />
        <path d="M4 20.5C4 18 6 16 8.5 16H11.1"
          stroke="#323232"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round" />
        <path fillRule="evenodd"
          clipRule="evenodd"
          d="M14 21.5H16.3L19.7 18.1C20.1 17.7 20.1 17.1 19.7 16.7L18.8 15.8C18.4 15.4 17.8 15.4 17.4 15.8L14 19.2V21.5V21.5H14Z" stroke="#323232" strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round" />
      </svg>
  ...
  check_round_square: (color: string, size: number) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
  ...
  profile_check: (color: string, size: number) => {
    return (
      <svg width={size}
        height={size}
        viewBox="0 0 26 25"
        ...
        <circle cx="13.0001"
          ...
          strokeLinecap="round"
          strokeLinejoin="round" />
        <path d="M4.99683 20.5033C4.99683 18.0173 7.01267 16.0015 9.4987 16.0015H12.0828"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round" />
        <path d="M20.0031 17.4399L17.0019 20.4412L15.2021 18.6404"
          stroke="#323232"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round" />
  ...
  arrow_right: (color: string, size: number) => {
    return (
      <svg width={size}
        height={size}
        viewBox="0 0 24 25"
  ...
  attach:(color:string,size:number)=>{
    return(
      <svg width={size}
       height={size}
       viewBox="0 0 26 26"
      ...
      <path d="M10.9991 14.0006L11.9525 14.954C12.703 15.7045 13.7209 16.1262 14.7822 16.1262C15.8436 16.1262 16.8614 15.7045 17.6119 14.954L20.6442 11.9218C22.4571 10.1086 22.4571 7.16918 20.6442 5.35604V5.35604C18.831 3.5431 15.8916 3.5431 14.0784 5.35604L13.1911 6.24441" 
       stroke={color}
       strokeWidth="1.5" 
       strokeLinecap="round" 
       strokeLinejoin="round"/>
      <path d="M15.0008 10.9993L14.0474 10.0459C13.297 9.29541 12.2791 8.87378 11.2177 8.87378C10.1564 8.87378 9.13852 9.29541 8.38806 10.0459L5.35579 13.0782C3.54286 14.8913 3.54286 17.8308 5.35579 19.6439V19.6439C7.16893 21.4568 10.1084 21.4568 11.9215 19.6439L12.8089 18.7555" 
      stroke={color} 
      strokeWidth="1.5" 
      strokeLinecap="round" 
      strokeLinejoin="round"/>
