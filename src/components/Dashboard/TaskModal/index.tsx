              ...
              <div className="flex flex-row gap-[24px]">
                ...
                >
                  ...
                  <div
                    ...
                    } absolute overflow: auto w-[173px] h-[160px] z-2 bg-white p-XS bottom-10 right-0 shadow-select rounded-lg`}
                  >
                    <div>
                      <Input
                        autoFocus={true}
                        className="pr-L border-none bg-lightgray_200 h-XL outline-none placeholder-text-xs"
