  ...
  const keyDownHandler = (e) => {
    if (e.key === "Enter") {
      if (data.length === tags.length) {
        setNewTagsState([
          ...newTags,
          { id: 0, color: "blue_secondary", title: searchValue },
        ]);
      }
    }
  };
          ...
          <div className="flex flex-col w-[1153px] gap-[40px]">
            <div className="flex flex-row-reverse items-center gap-[8px]">
              ...
              <Select
                ...
                name={"projects"}
                onChange={() => {}}
                className="w-[158px] h-[37px] rounded-md border border-[#E9EBF0] text-right py-[8px] pr-[5px] pl-[4px]"
              ></Select>
              <span>برای</span>
              <div
                className="border-dashed border-2 rounded-full border-[#c1c1c1] w-[34px] h-[34px] flex justify-center items-center"
                onClick={() => {
                  setShareModal(!shareModal);
                }}
              >
